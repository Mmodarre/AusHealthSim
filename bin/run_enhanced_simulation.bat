@echo off
REM Wrapper script for the Enhanced Health Insurance Simulation
...
REM Run the Python script for enhanced simulation
ECHO Running enhanced simulation from %START_DATE% to %END_DATE% with %MEMBERS_PER_DAY% members per day...
...
ECHO Enhanced simulation completed!